resource "akamai_appsec_aap_selected_hostnames" "policy2" {
...
resource "akamai_appsec_aap_selected_hostnames" "andrew" {
  config_id          = local.config_id
...
resource "akamai_appsec_aap_selected_hostnames" "policy1" {
  config_id          = local.config_id
