...
resource "akamai_cloudcertificates_certificate" "stokroteczka" {
  base_name      = "stokroteczka"
...
resource "akamai_cloudcertificates_upload_signed_certificate" "stokroteczka" {
