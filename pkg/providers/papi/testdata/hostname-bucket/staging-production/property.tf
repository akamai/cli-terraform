...
resource "akamai_property_hostname_bucket" "test-edgesuite-net-hostname-bucket-staging" {
  property_id   = akamai_property_activation.test-edgesuite-net-staging.property_id
  contract_id   = var.contract_id
  group_id      = var.group_id
  network       = "STAGING"
  note          = "staging note"
