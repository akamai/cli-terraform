...
| `--rule-format` (string) | Exports your property configuration using the specified rule format version. Use this to convert rules to a different rule format during export. This only affects the exported configuration and does not modify the property on the server. <br /><br /> <blockquote><b>Note:</b> Must be a valid dated rule format, for example <code>v2024-02-12</code>, or <code>latest</code> (only allowed for properties using JSON format for rules).</blockquote> | `akamai terraform export-property --rule-format "v2024-02-12" "my-property-name"` |
...
| `--rule-format` (string) | Exports your property include configuration using the specified rule format version. Use this to convert rules to a different rule format during export. This only affects the exported configuration and does not modify the include on the server. <br /><br /> <blockquote><b>Note:</b> Must be a valid dated rule format, for example <code>v2024-02-12</code>.</blockquote> | `akamai terraform export-property-include --rule-format "v2024-02-12" "C-0N7RAC7" "my-property-include"` |
